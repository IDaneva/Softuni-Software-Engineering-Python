...
print(controller.create_car("SportsCar", "Porsche 78 Boxster", 470))
print(controller.create_car("SportsCar", "Porsche 718 Boxster", 470))
print(controller.create_car("SportsCar", "Porsche 7 Boxster", 470))
print(controller.create_car("SportsCar", "Porsche 18 Boxster", 470))
