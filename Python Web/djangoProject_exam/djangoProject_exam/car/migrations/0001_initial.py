# Generated by Django 5.0.2 on 2024-02-24 08:27

import django.core.validators
import django.db.models.deletion
import djangoProject_exam.car.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[djangoProject_exam.car.models.validate_car_year])),
                ('image_url', models.URLField(error_messages={'unique': 'This image URL is already in use! Provide a new one.'}, unique=True)),
                ('price', models.DecimalField(decimal_places=3, max_digits=20, validators=[django.core.validators.MinValueValidator(1.0)])),
