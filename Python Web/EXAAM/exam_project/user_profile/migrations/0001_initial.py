...
import exam_project.user_profile.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=15, validators=[exam_project.user_profile.models.CustomMinLengthValidator(3), exam_project.user_profile.models.validate_username])),
